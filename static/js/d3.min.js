...
! function (t, n) {
    ...
    function Yc(t, n) {
        ...
        if (i) {
            n = null == n ? null : n + "";
            for (r in i)
                if ((e = i[r]).state > wm && e.name === n) return new Uc([
                    [t]
                ], zm, n, (+r))
        }
        return null
    ...
    function Il(n) {
        ...
        function u() {
            ...
            function o() {
                ...
                _ < h && (S *= -1, t = l, l = v, v = t, t = h, h = _, _ = t, k in fx && Y.attr("cursor", sx[k = fx[k]])), g < d && (A *= -1, t = p, p = y, y = t, t = d, d = g, g = t, k in lx && Y.attr("cursor", sx[k = lx[k]])), z = E.selection, w && (h = z[0][0], _ = z[1][0]), M && (d = z[0][1], g = z[1][1]), z[0][0] === h && z[0][1] === d && z[1][0] === _ && z[1][1] === g || (E.selection = [
                    [h, d],
                    [_, g]
                ], r.call(T), F.brush())
            }
            ...
            if (f.apply(this, arguments)) {
                ...
                "overlay" === k ? E.selection = z = [
                    [l = n === ax ? P : D[0], p = n === ux ? q : D[1]],
                    [v = n === ax ? L : l, y = n === ux ? R : p]
        ...
        return e.move = function (t, e) {
            ...
            return arguments.length ? (s = "function" == typeof t ? t : Sl([
                [+t[0][0], +t[0][1]],
                [+t[1][0], +t[1][1]]
            ]), e) : s
        }, e.filter = function (t) {
    ...
    function Eh(t) {
        ...
        return Dx = Ox = null, Ax === 1 / 0 || Ex === 1 / 0 ? [
            [NaN, NaN],
            [NaN, NaN]
        ] : [
            [Ax, Ex],
    ...
    function Gp(t) {
        ...
        return n.stream = function (t) {
                ...
                return arguments.length ? (S = null == t ? (N = l = h = p = null, _p) : ip(N = +t[0][0], l = +t[0][1], h = +t[1][0], p = +t[1][1]), o()) : null == N ? null : [
                    [N, l],
                    [h, p]
                ]
            }, n.scale = function (t) {
    ...
    var Om = "$",
        ...
        Im = {}; of .prototype = Object.create(ws.prototype);
